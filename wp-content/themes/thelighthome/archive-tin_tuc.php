...
?>
<div class="wrap-crumbs container my-3 my-md-4"><div id="crumbs" class="list-crumb text-capitalize"><a rel="nofollow" href="<?php echo get_bloginfo( 'url' ); ?>"><i class="fa fa-home mr-1"></i>Trang chủ</a> <i class="fa fa-angle-right mx-1" style="color: #646464;"></i> <span class="current">Tin tức</span></div></div>
